            ...
            {experienceData.map((exp, index) => (
              <div key={exp.company} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
                ...
                <div className="w-full md:w-[calc(50%-2.5rem)]">
                   <div className="bg-background/20 backdrop-blur-lg border border-border/20 p-6 rounded-lg shadow-lg transform transition-transform duration-300 md:group-hover:scale-105">
